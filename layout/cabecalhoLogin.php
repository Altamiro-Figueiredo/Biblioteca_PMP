...
<head>
    ...
    <!-- <link rel="shortcut icon" href="/layout/images/estrutura/favicon.png" type="image/x-icon">   -->
    <link rel="shortcut icon" href="<?= __ROOT__ ?>/layout/images/estrutura/favicon.png?v=2" type="image/x-icon">
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?= __ROOT__ ?>/layout/bootstrap_4.5/css/bootstrap.min.css">


    <link rel="stylesheet" href="<?= __ROOT__ ?>/layout/css/index.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.13.1/css/all.min.css" integrity="sha512-xA6Hp6oezhjd6LiLZynuukm80f8BoZ3OpcEYaqKoCV3HKQDrYjDE1Gu8ocxgxoXmwmSzM4iqPvCsOkQNiu41GA==" crossorigin="anonymous" />

    <title>Cartão Servidor</title>
    ...
    <div class="container-fluid header corPrincipal">
        <div class="container p-0">
            <nav class="navbar navbar-dark navbar-expand-lg pl-0">
                ...
                <a class="mx-auto logoMenu" href="<?= __ROOT__ ?>/index.php">
